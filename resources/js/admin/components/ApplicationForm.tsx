...
const ApplicationForm: React.FC<ApplicationFormProps> = ({ onSubmit, selectedPosition, userDetails }) => {
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="text-center pt-6">
                <button
                  type="submit"
                  className="font-bold py-4 px-12 rounded-lg text-lg transition-all duration-300 transform shadow-lg bg-blue-600 hover:bg-blue-700 text-white cursor-pointer"
                >
                  SUBMIT APPLICATION
                </button>
              </div>
